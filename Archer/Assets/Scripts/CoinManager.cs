...
public class CoinManager : MonoBehaviour
{
	...
	public void AddCoins(Vector3 collectedCoinPosition, int amount,int objectType,Color color)
	{
		Vector3	target = GameObject.FindGameObjectWithTag("Player").transform.position+new Vector3(0,0,10);
